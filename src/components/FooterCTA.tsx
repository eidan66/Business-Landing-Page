          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                Let's discuss your specific challenges and create a plan that gets results. 
              ...
              <div className="space-y-4 mb-8">
                {[
                  'Immediate clarity on your biggest opportunities',
                  'Custom action plan you can implement right away',
                  'Zero obligation - just valuable insights for your business'
                ].map((benefit, index) => (
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3 text-slate-300">
                  ...
                  <span>danny@businessgrowth.com</span>
                </div>
                <div className="flex items-center space-x-3 text-slate-300">
              ...
              {isSubmitted ? (
                ...
                <div className="bg-white rounded-2xl p-8">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-slate-600">No sales pitch. Just valuable insights for your business.</p>
                  </div>

                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                      <Label htmlFor="footer_name" className="text-slate-700 font-medium">Full Name *</Label>
                      <Input
                        id="footer_name"
                    ...
                    <div>
                      <Label htmlFor="footer_email" className="text-slate-700 font-medium">Email Address *</Label>
                      <Input
                        id="footer_email"
                        type="email"
                    ...
                    <div>
                      <Label htmlFor="footer_phone" className="text-slate-700 font-medium">Phone Number</Label>
                      <Input
                        id="footer_phone"
                        type="tel"
      ...
      <footer className="bg-slate-800 py-12">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {/* Company info */}
            <div>
              <h3 className="text-white font-bold text-xl mb-4">Business Growth Consulting</h3>
              <p className="text-slate-400 mb-4">
                Helping businesses unlock their full potential through strategic consulting and proven methodologies.
              </p>
          ...
          <div className="border-t border-slate-700 mt-8 pt-8 text-center">
            <p className="text-slate-400">
              © 2024 Business Growth Consulting. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
